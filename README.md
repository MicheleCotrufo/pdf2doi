...
This is a functionality available only in Windows (and so far it has been tested only in Windows 10). It adds additionaly commands to the context menu of Windows
